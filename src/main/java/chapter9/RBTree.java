...
class RBTree {
		...
		if (rbRoot == null) {
			...
			while (true) {
				...
				if (parent.isViolationThirdRule()) {
					...
					// внутренний внук узла grandParent, науршение в ЛЕВОЙ части дерева
	 ...
	 * @param parent 	  ссылка на родительский узел узла нарушителя
	 */
	...
	/**
	 * Выполнить ЛЕВОЙ поворот для ВНЕШНОГО потомка
	 *
	 * @param grandParent ссылка на узел являющийся предком узла нарушителя
	 * @param parent ссылка на родительский узел узла нарушителя
	 */
	 ...
	 * @param grandParent ссылка на узел являющийся предком узла нарушителя
	 * @param parent 	  ссылка на родительский узел узла нарушителя
	 * @param current 	  ссылка на узел нарушитель
	 */
