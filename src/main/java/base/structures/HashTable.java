...
public interface HashTable<T> {
	...
	/**
	 * Получить первое простое число большее чем {@param min}
	 *
	...
	/**
	 * @return коэффицент наполненности хэш-таблицы
	 */
	 ...
	 * предпологается что хэш-таблица не заполнена
	 *
	 * @param item элемент данных
	 */
	void insert(T item);
	...
	/**
	 * Удалить элемент данных из хэш-таблицы
	 *
	 * @param item элемент данных
